...
export KUBECONFIG=$USER/.bluemix/plugins/container-service/clusters/boeee1qd0uhgsckare0g/kube-config-dal10-sovrin-metasystem-gf.yml
...
helm upgrade sgfv3-latest helm --install --force --namespace default --kubeconfig $KUBECONFIG -f ./helm/bbu_values.yaml
echo "Successfully upgraded environment BBU"
