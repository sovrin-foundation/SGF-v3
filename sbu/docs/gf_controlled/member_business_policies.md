...
conduct business.
3. A Member MUST attest and provide supporting evidence to the DIBE Consortiumn in the
...
2. To apply, an Organization MUST submit a written application to the DIBE Consortium Governing Body responsible for Member applications as directed on the DIBE Consortium website.

3. The Member application process MUST follow the guidelines for Self-Certification,
Certification, or Accreditation as specified by the DIBE Consortium Trust Assurance Framework.

4. In evaluating and prioritizing Member applications, the DIBE Consortium MUST take
into account:
...
1. Before a Member may qualify to have an active Validator Node on the DIBE Consortium Ledger, the Member MUST:
	...
	1. 	Submit an executed copy of the DIBE Consortium Member Agreement and receive a countersigned copy from the DIBE Consortium.
...
Validator Node is activated on any DIBE Consortium Ledger network:

	1. The DIBE Consortium MUST list the Member's Public Profile information on the DIBE Consortium website.
	1. The Member MUST make a public announcement approved by the DIBE Consortium that their Organization has been approved as a DIBE Consortium Steward.
...
3. In the case of any of the changes listed in #2 above, the responsible DIBE Consortium Governing Body MAY require the Member to requalify.
...
2. A Member who is suspended MUST not have an active Node on any DIBE Consortium Ledger network until such time as Member is able to provide reasonable assurance to the responsible DIBE Consortium Governing Body that:
	1.     The Member is back in compliance with all requirements of the DIBE Consortium Governance Framework, and
	1.     The Member has the ability to maintain compliance for the foreseeable future.

3. At the request of a suspended Member, the responsible DIBE Consortium Governing Body MUST examine the Member's remediation efforts and make one of the following decisions:
...
3. During the transition period between approval of the Governance Framework and the Founding Member Deadline, any Founding Member who has not executed the new DIBE Consortium Member Agreement and Member Data Processing Agreement SHOULD disconnect their Node from the DIBE Consortium Main Network until such time as the Member has executed the new DIBE Consortium Member Agreement and Member Data Processing Agreement and received the countersigned copy back from the DIBE Consortium.
